...
\update{1}{Several TEE designs exist. ARM TrustZone is an example of a commercial processor TEE that is used in many mobile devices, while Sanctum~\cite{sanctum} serves as a good example of a research TEE system. For simplicity, we focus on Intel's SGX and use it as a case study to discuss the strengths and limitations of enclaves.}
