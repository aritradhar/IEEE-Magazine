...
\update{1}{Several other TEE designs exist too. ARM TrustZone is an example of a TEE that is used in many commercial mobile devices, while Sanctum~\cite{sanctum} serves as a good example of a research TEE system. For simplicity, in this article we focus on Intel's SGX and use it as a case study to discuss the strengths and limitations of enclaves.}
