...
\update{5}{\protection and \proximitee are systems where a dedicated chip complements and improves the security guarantees of enclaves. Some previous TEE designs have leveraged dedicated security chips to implement a TEE that can be attested.}
