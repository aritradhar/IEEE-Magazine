...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.7]{Kostiainen-Fig1.pdf}
...
\begin{figure}[t]
    \begin{center}
        ...
        \centering
            \includegraphics[trim={0 8.5cm 17cm 0}, clip, width=\linewidth]{Kostiainen-Fig2a.pdf}
    ...
    \begin{center}
        ...
        \centering
       \includegraphics[trim={0 8cm 15cm 0}, clip, width=0.9\linewidth]{Kostiainen-Fig2b.pdf}
